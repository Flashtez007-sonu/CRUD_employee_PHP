...
<div class="container">
    <div class="row">
        ...
        <?php if(count($db->viewemployee("employees"))): ?>
        ...
        <div class="col-sm-12">
            <table class="table table-dark">
                ...
                <tbody>
                    ...
                    <?php foreach($db->viewemployee("employees") as $row): ?>
                        <tr>
                            <td><?php echo strtoupper($row['name']);  ?></td>
                            <td><?php echo $row['email'];  ?></td>
                            <td><?php echo strtoupper($row['department']);  ?></td>
                            <td>
                                <a href="view-employee.php?id=<?php echo $row['id'] ?>" class="text-primary">
        ...
        <?php else: ?>
            ...
            <div class="col-sm-12">
                <h3 class="alert alert-danger mt-5 text-center"> No Employee Data Found</h3>
            </div>
